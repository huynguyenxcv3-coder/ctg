...
export function Home() {
  ...
  return (
    <div ref={containerRef} className="bg-white min-h-screen selection:bg-zinc-200 selection:text-zinc-900 relative font-sans text-zinc-900">
      ...
      <section className="pt-28 pb-20 md:pt-40 md:pb-28 relative z-10 bg-white overflow-hidden">
            ...
            >
              <div className="mb-6 md:mb-10 max-w-6xl w-full">
                <SplitText 
                  ...
                  className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight text-zinc-900 leading-[1.15]"
                  delay={40}
                  duration={0.6}
                  textAlign="center"
                />
              ...
              <motion.p 
                variants={fadeUp}
                className="text-base md:text-xl text-zinc-500 mb-10 md:mb-14 leading-relaxed max-w-3xl font-normal px-4"
              >
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-6 w-full sm:w-auto px-6">
                <Button asChild size="lg" className="w-full sm:w-[260px] md:w-[280px] font-bold text-sm md:text-[15px] h-14 md:h-16 rounded-full shadow-md hover:shadow-lg transition-all duration-300 bg-zinc-900 text-white border border-zinc-900 uppercase tracking-widest p-0">
                  <Link to="/lien-he" className="flex items-center justify-center gap-2 w-full h-full px-4">
                    Yêu cầu sản xuất
                  </Link>
                </Button>
                <Button asChild variant="outline" size="lg" className="w-full sm:w-[260px] md:w-[280px] font-bold text-sm md:text-[15px] h-14 md:h-16 rounded-full border-zinc-200 hover:border-zinc-900 hover:bg-zinc-50 transition-all duration-300 text-zinc-700 uppercase tracking-widest p-0">
                  <a href="#xuong-san-xuat" className="flex items-center justify-center gap-2 w-full h-full px-4">
                    Năng lực sản xuất
                  </a>
                </Button>
              </motion.div>
      ...
      <section id="xuong-san-xuat" className="py-16 md:py-24 relative z-10 scroll-mt-24 bg-zinc-50 border-b border-zinc-100">
        <div className="container-custom">
          <motion.div 
            style={{ opacity }}
            className="w-full rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden bg-zinc-900 shadow-xl aspect-[16/9] lg:aspect-[21/9] relative group border-2 md:border-[3px] border-white"
          >
            <motion.img 
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex items-end p-6 md:p-12">
               <div className="text-white max-w-3xl">
                  ...
                  <h3 className="text-2xl md:text-4xl font-bold tracking-tighter leading-tight">Làm chủ công nghệ <br className="hidden md:block"/> và kỹ thuật</h3>
               </div>
            </div>
          </motion.div>
        </div>
      ...
      {/* Concrete Stats Section - Balanced Space */}
      <section className="py-16 md:py-24 bg-white border-b border-zinc-100 relative z-10">
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-zinc-100 w-full mx-auto max-w-5xl">
            {stats.map((s, i) => (
              <motion.div 
                key={s.label} 
              ...
              >
                <div className="text-4xl md:text-5xl font-bold text-zinc-900 mb-3 tracking-tighter">{s.value}</div>
                <div className="text-xs font-bold text-zinc-400 uppercase tracking-[0.3em]">{s.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="mb-14 md:mb-20 text-center w-full mx-auto px-4 max-w-3xl">
            ...
            <motion.p 
              ...
              className="text-zinc-500 text-base md:text-lg font-normal leading-relaxed mx-auto"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 w-full mx-auto max-w-6xl">
            {services.map((service, i) => (
              ...
              >
                ...
                <div className="p-8 md:p-12 flex-1 flex flex-col">
                  <h3 className="text-xl md:text-2xl font-bold text-zinc-900 mb-4 tracking-tight">{service.title}</h3>
                  <p className="text-zinc-500 text-sm md:text-base mb-8 leading-relaxed font-normal">{service.desc}</p>
                  <div className="mt-auto pt-6 md:pt-8 border-t border-zinc-50">
                    <Link to="/san-pham" className="inline-flex items-center text-xs font-bold text-zinc-900 hover:text-zinc-500 transition-colors uppercase tracking-[0.2em]">
      ...
      <section className="relative block w-full py-32 md:py-64 z-10 px-4">
        <div className="container-custom flex justify-center p-0">
           <div className="bg-zinc-900 rounded-[2.5rem] md:rounded-[4rem] py-32 px-8 md:py-52 md:px-24 text-center relative overflow-hidden mx-auto shadow-2xl w-full max-w-7xl flex flex-col items-center">
              ...
              >
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 md:mb-8 tracking-tighter text-white uppercase mx-auto leading-[1.2] px-2">
                  Yêu cầu sản xuất <br className="md:hidden" /> & Tư vấn
                </h2>
                <p className="text-zinc-400 mb-8 md:mb-12 text-sm md:text-lg font-normal leading-relaxed mx-auto max-w-2xl px-4">
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4 md:gap-6 mx-auto w-full sm:w-auto px-4">
                  <Button asChild size="lg" className="w-full sm:w-[260px] md:w-[280px] font-bold uppercase tracking-widest text-[12px] md:text-sm h-14 md:h-16 px-6 md:px-8 rounded-full shadow-lg hover:translate-y-[-2px] transition-all duration-300 bg-white text-zinc-900 hover:bg-zinc-100">
                    <Link to="/lien-he" className="flex items-center justify-center w-full h-full">Yêu cầu sản xuất ngay</Link>
                  </Button>
                  <Button asChild variant="outline" size="lg" className="w-full sm:w-[260px] md:w-[280px] font-bold uppercase tracking-widest text-[12px] md:text-sm h-14 md:h-16 px-6 md:px-8 bg-transparent text-white border-white hover:bg-white hover:text-black rounded-full transition-all duration-300">
