  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-industrial-silver visible-grid p-4">
      <SEO
        ...
        description="Trang bạn đang tìm không tồn tại. Quay về trang chủ Cường Thông Gió."
      />
      <div className="text-center max-w-xl bg-white p-16 industrial-shadow border border-industrial-border">
         ...
         <h1 className="text-8xl font-sans font-bold text-industrial-black mb-4 tracking-tighter">404</h1>
         <h2 className="text-2xl font-sans font-bold mb-6 italic uppercase">KHÔNG TÌM THẤY TRANG</h2>
