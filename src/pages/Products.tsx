            ...
            {danhSachSanpham.map((hangMuc, soThuTu) => (
              ...
              >
                ...
                <div className="space-y-8 lg:py-6">
                  ...
                  <div className="pt-2">
                    <Link to="/lien-he">
                      <Button size="lg" className="w-full sm:w-auto min-w-[240px] md:min-w-[260px] rounded-full uppercase tracking-[0.2em] font-bold text-[11px] md:text-[12px] px-10 md:px-12 h-14 md:h-16 shadow-lg hover:shadow-zinc-200 transition-all">
                        Yêu cầu sản xuất
                      </Button>
                    </Link>
                  </div>
