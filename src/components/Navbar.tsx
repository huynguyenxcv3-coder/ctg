...
export function Navbar() {
  ...
  return (
    <header className={cn(
      ...
      <div className="container-custom h-16 md:h-[4.5rem] flex items-center justify-between">
        <Link 
          to="/" 
          onClick={() => setIsOpen(false)}
          className="z-50 flex items-center gap-2 md:gap-3"
        >
          <img src="/logo.png" alt="Cường Thông Gió" className="h-11 md:h-14 w-auto object-contain" />
          <span className="text-[15px] md:text-xl font-bold tracking-tighter text-zinc-900 uppercase">
