      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 text-center md:text-left">
          <div className="md:col-span-2">
            <Link to="/" className="inline-flex items-center justify-center md:justify-start gap-3 mb-6 w-full md:w-auto">
              <img src="/logo.png" alt="Cường Thông Gió" className="h-12 md:h-14 w-auto object-contain" />
              <span className="text-lg md:text-xl font-bold tracking-tight text-zinc-900 uppercase text-left">
