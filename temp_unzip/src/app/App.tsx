  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] py-20 px-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Main Content Card */}
        <div className="bg-white rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.08)] p-14">
          <div className="grid grid-cols-2 gap-20">
            ...
            <div>
              <form className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#1a1a1a] text-white uppercase py-4 rounded-full hover:bg-black transition-all duration-200 font-semibold tracking-widest text-sm mt-2"
                >
                  GỬI YÊU CẦU TƯ VẤN
                </button>
              </form>
